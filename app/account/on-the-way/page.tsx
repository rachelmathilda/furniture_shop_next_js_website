...
const ON_THE_WAY = [
  ...
  },
  {
    ...
    eta: "May 28, 2026",
    tracking: "MRP-4412-B",
    img: "https://images.unsplash.com/photo-1493663284031-b7e3aaa4e2b2?w=400&h=200&fit=crop",
  },
  {
    id: 3,
    name: "Reed Lamp",
    ...
    eta: "Jun 3, 2026",
    tracking: "MRP-9903-C",
    img: "https://images.unsplash.com/photo-1507473885765-e6ed057f782c?w=400&h=200&fit=crop",
  },
];
        ...
        <div className="flex-1 space-y-5">
          {ON_THE_WAY.map((order) => {
            ...
            return (
              <div
                key={order.id}
                className="bg-[#F8F6F3] rounded-2xl overflow-hidden flex"
              >
