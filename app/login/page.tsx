  ...
  return (
    <div className="min-h-screen flex bg-[#C1714F]">
      ...
      <div className="flex-1 flex flex-col justify-between p-10 relative overflow-hidden">
        ...
        <div className="flex justify-center">
          <div className="relative">
            <div className="w-72 h-72 rounded-[60%_40%_55%_45%/50%_60%_40%_50%] bg-white/20 flex items-end justify-center overflow-hidden">
              <Image
      ...
      <div className="w-[560px] bg-white flex flex-col justify-center px-14 py-16">
        <h2 className="text-3xl font-light text-gray-700 mb-10">Welcome Back!</h2>

        <div className="space-y-6">
          <div>
            <p className="text-gray-600 mb-2">Username/ E-mail</p>
          ...
          <p className="text-center text-gray-400 text-sm">Or log in with</p>
          ...
          <button onClick={handleSubmit} className="w-full bg-[#C1714F] hover:bg-[#A85F3F] text-white py-4 rounded-lg text-lg font-medium transition-colors">
            Sign In
          </button>

          <p className="text-center text-gray-500 text-sm">
            Don't have an account?{" "}
            <Link href="/register" className="text-[#C1714F] font-medium">Sign Up</Link>
          </p>
        </div>
      </div>
    </div>
